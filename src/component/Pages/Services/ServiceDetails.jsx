...
const ServiceDetails = () => {
  ...
  const { _id, service, price, image, photoshoot, description } = serviceInfo;
  ...
  const handleReview = (event) => {
    ...
    // post data
    fetch("https://server-side-azure-eight.vercel.app/allreviews", {
      method: "POST",
      headers: {
        ...
        <div className="container flex gap-5 flex-col mx-auto lg:flex-row">
          ...
          <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-0">
            ...
            <h2 className="font-bold">
              Photo Quantity : {photoshoot} and more.
            </h2>
          </div>
        </div>
      </section>
