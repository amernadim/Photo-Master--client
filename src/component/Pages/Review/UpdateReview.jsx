  ...
  return (
    <div className='mt-[95px] mb-5'>
      ...
      <div className="max-w-screen-xl gap-8 px-8 py-16 mx-auto border-2 border-black rounded-lg md:px-12 lg:px-10 xl:px-6 w-10/12 md:w-6/12">	
       <h2 className="text-4xl font-bold leading-tight lg:text-3xl">Update Review</h2> 
       <form onSubmit={handleUpdate} className="space-y-6 mt-3">
      <div>
       <textarea type="text" name="review" rows="3" className="w-full p-3 rounded"></textarea>
     </div>
     <button type="submit" className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded bg-orange-400 text-white">Update</button>
      </form>
     </div>
    </div>
  );
