  ...
  return ( 
    ...
    <div className="flex justify-between p-4">
      <div className="flex space-x-4">
        <div>
          <img src={reviewerPhoto} alt="" className="object-cover w-12 h-12 rounded-full dark:bg-gray-500" />
        </div>
        <div>
          <h4 className="font-bold">{reviewerName}</h4>
          <span className="text-xs dark:text-gray-400">{myDate.slice(0,10)}</span>
        </div>
      </div>
